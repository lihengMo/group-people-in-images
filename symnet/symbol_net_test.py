...
def get_map_feature(data):
    ...
    ReLU1 = mx.symbol.LeakyReLU(name='ReLU1', data=conv1, act_type='leaky', slope=0.1)
...
def get_resnet_test_symbol(units,filter_list):
    ...
    # softmax loss
    net = mx.sym.softmax(data=fc2, name='net')
    return net