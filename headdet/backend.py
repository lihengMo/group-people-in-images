...
FULL_YOLO_BACKEND_PATH  = "./headdet/full_yolo_backend.h5"   # should be hosted on a server
TINY_YOLO_BACKEND_PATH  = "./headdet/tiny_yolo_backend.h5"   # should be hosted on a server
SQUEEZENET_BACKEND_PATH = "./headdet/squeezenet_backend.h5"  # should be hosted on a server
MOBILENET_BACKEND_PATH  = "./headdet/mobilenet_backend.h5"   # should be hosted on a server
INCEPTION3_BACKEND_PATH = "./headdet/inception_backend.h5"   # should be hosted on a server
VGG16_BACKEND_PATH      = "./headdet/vgg16_backend.h5"       # should be hosted on a server
RESNET50_BACKEND_PATH   = "./headdet/resnet50_backend.h5"    # should be hosted on a server
